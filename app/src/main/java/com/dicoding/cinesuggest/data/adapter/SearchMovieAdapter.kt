package com.dicoding.cinesuggest.data.adapter
...
import com.dicoding.cinesuggest.view.Search.DetailSearchActivity

class SearchMovieAdapter(private val searchResults: List<SearchResponseItem>) :
